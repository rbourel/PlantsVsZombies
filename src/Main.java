...
public class Main {
	...
	public static void main(String[] args) {
		...
		StdDraw.text(0.5, 0.85, "Le but du jeu est d'�liminer les Zombie");
		StdDraw.text(0.5, 0.8, "Pour ceci il existe plusieurs plantes achetable gr�ce au nombre de Soleil que vous avez");
		StdDraw.text(0.5, 0.75, "Vous pouvez voir votre nombre de Soleil en temps r�el en haut � gauche");
		...
		StdDraw.text(0.5, 0.4, "Le Jalapeno tue tout  les Zombies a sa droite, il explose rapidement apr�s avoir ete placez");
